...
public var appIdentifier: String { return "" } // The bundle identifier of your app
public var appleID: String { return "" } // Your Apple email address

public var teamID: String { return "" } // Developer Portal Team ID
public var itcTeam: String? { return nil } // iTunes Connect Team ID (may be nil if no team)
